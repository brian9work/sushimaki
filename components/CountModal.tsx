...
export default function CountModal() {
  ...
  return (
    ...
    '>
      <div className='bg-white rounded-3xl p-6 w-11/12 max-w-sm shadow-2xl transform transition-all scale-100'>
        <div className="flex justify-between items-center mb-4">
          <h4 className='font-bold text-xl text-gray-800'>Agregar Platillo</h4>
